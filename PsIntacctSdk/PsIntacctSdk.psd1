#
# Module manifest for module 'PsIntacctSdk'
#
...
GUID = 'dfcd59de-ca5d-4cf3-ba09-97bebbeb07f6'
...
Description = 'PowerShell wrapper of the Sage Intacct SDK for .NET'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @('Intacct','.Net','PowerShell','Sage')

        # A URL to the license for this module.
        # LicenseUri = ''

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/craibuc/PsIntacctSdk'
